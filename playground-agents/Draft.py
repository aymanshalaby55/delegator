...
def update(content: str) -> str: 
    ...
    return f"document has been successfully updated! this is the current content : \n {document_content}"
...
def save(filename: str) -> str:
    ...
    try: 
        ...
        return "doccumetn has been saved"
...
def should_continue(state: AgentState) -> str: 
    ...
    for message in reversed(messages): 
        if(isinstance(messages , ToolMessage) and "saved" in message.content.lower() and "document" in message.content.lower()):
            return "end" 
